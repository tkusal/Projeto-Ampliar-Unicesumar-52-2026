...
============
**Algoritmos e Lógica de Programação** [52/2026]
...
Lembrando que as aulas acontecem toda **quarta e quinta-feira**, das **20:30 às 22:00**. Vamos explorar os mistérios dos Algoritmos e da Lógica de Programação, utilizando a **linguagem C** como nossa ferramenta principal. Estou empolgado para ver o que vamos aprender juntos! Nos vemos lá!

Mais informações, [clique aqui](https://sites.google.com/view/programa-ampliar/2026/tecnologia-512026/algoritmos-e-l%C3%B3gica-de-programa%C3%A7%C3%A3o)!
...
---
O cronograma poderá ser acessado [clicando aqui](https://monitoria.tkusal.com.br/cronograma)!

---
## Pré-Requisitos

Para ser possível praticarem os exercícios, precisarão de um editor de textos/códigos ou IDE instalado, assim como o compilador da linguagem C (GCC).
...
- **Contras**: Desenvolvimento estagnado, menos suporte para projetos grandes e complexos. Excesso de bugs e problemas na execução. Não recomendo.
